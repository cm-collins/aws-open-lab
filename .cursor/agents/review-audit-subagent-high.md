...
description: High-depth review subagent for parallel code audits. Writes only to orchestrator-assigned paths under tmp/code-review/. Read-only for production code.
---
