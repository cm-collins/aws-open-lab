...
Labs marked “not written yet” land when someone has run them on a real account. Labs **1** and **2** are ready; use [docs/labs-1-2-checklist.md](docs/labs-1-2-checklist.md) to confirm you are done before Lab 3. For a broader DevOps learning checklist (including Labs 3–6 and follow-on topics), see [docs/devops-engineer-path.md](docs/devops-engineer-path.md).
